...
function textOp(impl: (a: string, b: string, ignore: boolean) => any) {
    return function(a: string, b: string, ignore: boolean, accentFoldingFiltering: string | string[]) {
        b += "";
        if (ignore) {
...
function operator(op: string, a: any, b: any, ignore: boolean, accentFoldingFiltering?: string | string[]): string {
    if (b != null) {
        if (typeof b === 'string') {
...
export const operators = {
    ...
    eq(a: any, b: any, ignore: boolean, accentFoldingFiltering: string | string[]) {
        return operator("==", a, b, ignore, accentFoldingFiltering);
    },
    neq(a: any, b: any, ignore: boolean, accentFoldingFiltering: string | string[]) {
        return operator("!=", a, b, ignore, accentFoldingFiltering);
    },
